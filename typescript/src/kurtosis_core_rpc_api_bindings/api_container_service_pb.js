...
goog.exportSymbol('proto.api_container_api.UnloadLambdaArgs', null, global);
 ...
 * @constructor
 */
proto.api_container_api.UnloadLambdaArgs = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.api_container_api.UnloadLambdaArgs, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.api_container_api.UnloadLambdaArgs.displayName = 'proto.api_container_api.UnloadLambdaArgs';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.api_container_api.UnloadLambdaArgs.prototype.toObject = function(opt_includeInstance) {
  return proto.api_container_api.UnloadLambdaArgs.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.api_container_api.UnloadLambdaArgs} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api_container_api.UnloadLambdaArgs.toObject = function(includeInstance, msg) {
  var f, obj = {
    lambdaId: jspb.Message.getFieldWithDefault(msg, 1, "")
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.api_container_api.UnloadLambdaArgs}
 */
proto.api_container_api.UnloadLambdaArgs.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.api_container_api.UnloadLambdaArgs;
  return proto.api_container_api.UnloadLambdaArgs.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.api_container_api.UnloadLambdaArgs} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.api_container_api.UnloadLambdaArgs}
 */
proto.api_container_api.UnloadLambdaArgs.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.api_container_api.UnloadLambdaArgs.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.api_container_api.UnloadLambdaArgs.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.api_container_api.UnloadLambdaArgs} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.api_container_api.UnloadLambdaArgs.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getLambdaId();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.api_container_api.UnloadLambdaArgs.prototype.getLambdaId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.api_container_api.UnloadLambdaArgs} returns this
 */
proto.api_container_api.UnloadLambdaArgs.prototype.setLambdaId = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
