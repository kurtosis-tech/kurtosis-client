...
export class RegisterStaticFilesArgs extends jspb.Message {
  getStaticFilesToRegisterMap(): jspb.Map<string, boolean>;
  clearStaticFilesToRegisterMap(): void;
  serializeBinary(): Uint8Array;
...
export namespace RegisterStaticFilesArgs {
  export type AsObject = {
    staticFilesToRegisterMap: Array<[string, boolean]>,
  }
}

export class RegisterStaticFilesResponse extends jspb.Message {
  getStaticFileRelativeFilepathsMap(): jspb.Map<string, string>;
  clearStaticFileRelativeFilepathsMap(): void;
  serializeBinary(): Uint8Array;
...
export namespace RegisterStaticFilesResponse {
  export type AsObject = {
    staticFileRelativeFilepathsMap: Array<[string, string]>,
  }
}
