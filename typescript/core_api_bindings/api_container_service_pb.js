...
proto.api_container_api.RegisterStaticFilesArgs.toObject = function(includeInstance, msg) {
  var f, obj = {
    staticFilesToRegisterMap: (f = msg.getStaticFilesToRegisterMap()) ? f.toObject(includeInstance, undefined) : []
  };
...
proto.api_container_api.RegisterStaticFilesArgs.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = msg.getStaticFilesToRegisterMap();
      reader.readMessage(value, function(message, reader) {
...
proto.api_container_api.RegisterStaticFilesArgs.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getStaticFilesToRegisterMap(true);
  if (f && f.getLength() > 0) {
...
/**
 * map<string, bool> static_files_to_register = 1;
 * @param {boolean=} opt_noLazyCreate Do not create the map if
 * empty, instead returning `undefined`
 * @return {!jspb.Map<string,boolean>}
 */
proto.api_container_api.RegisterStaticFilesArgs.prototype.getStaticFilesToRegisterMap = function(opt_noLazyCreate) {
 ...
 */
proto.api_container_api.RegisterStaticFilesArgs.prototype.clearStaticFilesToRegisterMap = function() {
  this.getStaticFilesToRegisterMap().clear();
  return this;};
...
proto.api_container_api.RegisterStaticFilesResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    staticFileRelativeFilepathsMap: (f = msg.getStaticFileRelativeFilepathsMap()) ? f.toObject(includeInstance, undefined) : []
  };
...
proto.api_container_api.RegisterStaticFilesResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = msg.getStaticFileRelativeFilepathsMap();
      reader.readMessage(value, function(message, reader) {
        jspb.Map.deserializeBinary(message, reader, jspb.BinaryReader.prototype.readString, jspb.BinaryReader.prototype.readString, null, "", "");
         });
      break;
...
proto.api_container_api.RegisterStaticFilesResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getStaticFileRelativeFilepathsMap(true);
  if (f && f.getLength() > 0) {
    f.serializeBinary(1, writer, jspb.BinaryWriter.prototype.writeString, jspb.BinaryWriter.prototype.writeString);
  }
};
...
/**
 * map<string, string> static_file_relative_filepaths = 1;
 * @param {boolean=} opt_noLazyCreate Do not create the map if
 * empty, instead returning `undefined`
 * @return {!jspb.Map<string,string>}
 */
proto.api_container_api.RegisterStaticFilesResponse.prototype.getStaticFileRelativeFilepathsMap = function(opt_noLazyCreate) {
  return /** @type {!jspb.Map<string,string>} */ (
      jspb.Message.getMapField(this, 1, opt_noLazyCreate,
      null));
};
 ...
 */
proto.api_container_api.RegisterStaticFilesResponse.prototype.clearStaticFileRelativeFilepathsMap = function() {
  this.getStaticFileRelativeFilepathsMap().clear();
  return this;};
