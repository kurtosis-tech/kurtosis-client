...
### addServiceToPartition(ServiceID serviceId, PartitionID partitionId, [ContainerCreationConfig][containercreationconfig] containerCreationConfig, Func(String ipAddr, Map\<String, string\> generatedFileFilepaths, Map\<StaticFileID, string\> staticFileFilepaths) -\> ([ContainerRunConfig][containerrunconfig], error) generateRunConfigFunc) -\> ([ServiceContext][servicecontext] serviceContext, Map\<String, PortBinding\> hostPortBindings)
...
* `generateRunConfigFunc`: An anonymous function which receives three dynamic values as arguments: the ip address, the generated file paths and the static file paths created during the starting process; and creates the ContainerRunConfig that Kurtosis will use to run the service
...
### addService(ServiceID serviceId, [ContainerCreationConfig][containercreationconfig] containerCreationConfig, Func(String ipAddr, Map\<String, string\> generatedFileFilepaths, Map\<StaticFileID, string\> staticFileFilepaths) -\> ([ContainerRunConfig][containerrunconfig], error) generateRunConfigFunc ) -\> ([ServiceContext][servicecontext] serviceContext, Map\<String, PortBinding\> hostPortBindings)
